...
public class ModSpawnEggItem extends SpawnEggItem {
    ...
    public ModSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour, final int secondaryColour, final Properties properties) {
